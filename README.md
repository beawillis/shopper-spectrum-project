...
- [Methodology](#methodology)
    ...
    - [RFM Analysis & K-Means Clustering](#rfm-analysis--k-means-clustering)
...
1.  **Product Recommendation Engine**: Users can select a product and receive a list of top 5 recommended items based on collaborative filtering.
2.  **Customer Lifecycle Segmentation**: Users can input customer operational features (Recency, Frequency, Monetary) to instantly classify their lifecycle value tier.
